...
export default function IngestionDashboardPage() {
  ...
  return (
    <>
      {/* ✅ ไม่ให้ดู “เยื้อง/แปลก” เมื่อ AppShell มี padding-left:
          ใช้ container ชิดซ้าย (mr-auto) แทนการ center (mx-auto) */}
      <div className="min-h-[calc(100vh-3.5rem)] bg-[#0D1117] pb-8 pt-6 text-[#F0EEE9]">
        <div className="w-full max-w-7xl px-4 sm:px-6 lg:px-8 ml-0 mr-auto">
              ...
              <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-end">
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-lg border border-[#30363D] bg-[#161B22] px-3 py-2 text-sm font-medium text-[#F0EEE9] shadow-sm hover:bg-[#1F2933]"
                  >
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-sky-500 via-sky-400 to-sky-300 px-3 py-2 text-sm font-medium text-white shadow-sm hover:brightness-110"
                  >
                  ...
                  <div className="space-y-2">
                    {spacesPreview.map((s, idx) => (
                      ...
                      >
                        ...
                        <button className="shrink-0 text-xs font-medium text-sky-400 hover:underline">
                          Open
                        </button>
                      </div>
                    ))}
