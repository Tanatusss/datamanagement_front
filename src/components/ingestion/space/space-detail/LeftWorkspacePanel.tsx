...
import { WorkspacePanel } from "@/components/ingestion/space/WorkspacePanel";
...
export function LeftWorkspacePanel({ leftPanel, onClose }: Props) {
  return (
    <div className="rounded-2xl border border-slate-700 bg-slate-900/80 p-4 shadow-inner shadow-black/40">
      ...
      <div className="mt-3">
        <WorkspacePanel mode={leftPanel} compact />
      </div>
    </div>
  );
}
